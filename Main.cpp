...
bool InitD3D()
{
	...
	int adapterIndex = 0; // we'll start looking for directx12 compatible graphics devices starting at index 0
	...
	descriptorTableRanges[0].RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_CBV; // this is a range 
	...
	descriptorTable.NumDescriptorRanges = _countof(descriptorTableRanges); // we only have on raange
	...
	vBufferUploadHeap->SetName(L"Vertex Buffer Upload Resources Heap");
